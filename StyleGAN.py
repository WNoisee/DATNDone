...
train_selfie_path = r"E:\GAN\StyleGAN\testB"
...
# import os
#
# path = r"E:\GAN\StyleGAN\Anime"
# path_copy = r"E:\GAN\StyleGAN\testB"
#
# i=0
# arr = []
# for file_name in os.listdir(path):
#     if i < 2000:
#         new_file_name = os.path.join(path_copy, file_name)
#         os.rename(os.path.join(path, file_name), new_file_name)
#     i+=1
